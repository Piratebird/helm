...
content = content.replace('    global_opts.add_argument("-j", "--json", action="store_true", help="Output results as JSON")\n', '')
content = content.replace('    global_opts.add_argument("-l", "--lite", action="store_true", help="Lite mode: bypass Jackett and use public trackers")\n', '')
